        ...
        ?>
            <table class="table table-hover">
                ...
                ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($value[$produto['idProcedimento']]['tussProcedimento']) ?></td>
                ...
                <tfoot>
                    ...
                    <td></td>
                    <td></td>
                    <td class="fw-bold fs-5"><?php echo "Valor Total: R$" . $vlTotal ?></td>
                    <td colspan="2"><a href="../cadastros/finalizarCompra.php" class="btn btn-card-contra btn-lg">Finalizar Compra</a></td>
                </tfoot>
            </table>

        <?php
        } else {
            echo "<h3>Seu Carrinho está vazio.</h3><br>
              <p class='fs-5'>Clique aqui para voltar para <a class='btn btn-card-contra btn-sm' href='../parceiros.php'>Área de Parceiros</a></p>";
        }
        ?>
