...
<body>
  ...
  <div class="container py-5 col-8" id="">
    <h2 class="text-center">Login Parceiro</h2>
    <br>
    <fieldset class="p-4 rounded-3 field">
      <form action="<?php echo htmlspecialchars("./loginSecretoParceiro.php"); ?>" method="POST" id="frmIndividual">

        <div class="mb-3 col-8 m-auto">
          <label class="form-label" for="cnpjLogin">Login</label>
          <input type="text" class="form-control" maxlength="14" placeholder="Digite o CNPJ" id="cnpjLogin" name="cnpjLogin" required>
        </div>
