...
<body>
  ...
  <div class="container py-5 col-8" id="">
    ...
    <fieldset class="p-4 rounded-3 field">
      <form action="<?php echo htmlspecialchars("../administrativo/loginSecretoAdm.php"); ?>" method="POST" id="frmIndividual">

        <div class="mb-3 col-8 m-auto">
          <label class="form-label" for="nickLogin">Login</label>
          <input type="text" class="form-control" maxlength="11" placeholder="Digite seu CPF" id="nickLogin" name="nickLogin" required>
        </div>
